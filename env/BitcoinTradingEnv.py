...
class BitcoinTradingEnv(gym.Env):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.stationary_df = log_and_difference(self.df, features)
    ...
    def _next_observation(self):
        ...
        past_df = self.stationary_df[self.close_key][:
    ...
    def _current_price(self):
        return self.df[self.close_key].values[self.current_step + self.forecast_len] + 0.01
