...
class BitcoinTradingEnv(gym.Env):
    ...
    def _take_action(self, action):
        ...
        if action > 0:
            ...
            quantity = self.balance * abs(action)

            btc_bought = min(self.balance * quantity /
            ...
            # Sell/Short
            price = current_price * (1 - self.commission)
            quantity = self.btc_held * abs(action)

            btc_sold = self.btc_held * quantity
        ...
        if btc_sold > 0 or btc_bought > 0:
            self.trades.append({
                ...
                'quantity': btc_sold if btc_sold > 0 else btc_bought, 
    ...
    def get_quantity_from_distribution(self, action):
        pass
